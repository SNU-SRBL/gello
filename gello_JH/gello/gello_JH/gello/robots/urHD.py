...
class URTesollo(Robot):
    ...
    def get_observations(self) -> Dict[str, np.ndarray]:
        ...
        if self._use_gripper:
            ...
            gripper_obs = self.gripper.get_all_observations()
            gripper_pos = gripper_obs["normalized_position"]
            ...
            return {
                ...
                "fingertip_sensor": gripper_obs["sensor"],
                "finger_current": gripper_obs["current"],
                "finger_velocity": gripper_obs["velocity"],
                "fingertip_tcp": gripper_obs["tcp"],
            }
        else:
            return {
