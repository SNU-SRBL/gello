...
class URRobot(Robot):
    ...
    def __init__(self, robot_ip: str = "192.168.1.10", no_gripper: bool = False):
        ...
        if not no_gripper:
            ...
            from gello.robots.RHP12RN_gripper import RobotisGripper
            # self.gripper = RobotiqGripper()
            #self.gripper.connect(hostname=robot_ip, port=63352)
            self.gripper = RobotisGripper() # ROBOTIS RH-P12-RN
    ...
    def command_joint_state(self, joint_state: np.ndarray) -> None:
        ...
        if self._use_gripper:
            ...
            gripper_pos = int(joint_state[-1] * 740) # ROBOTIS RH-P12-RN
            self.gripper.move(gripper_pos) # ROBOTIS RH-P12-RN
