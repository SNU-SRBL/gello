...
class Gripper:
    def __init__(self, device_name="/dev/ttyUSB1", dxl_id=1, baudrate=3000000):
        ...
        self.DXL_MAX_POSITION = 740
        self.ADDR_SHUTDOWN = 48
    ...
    def set_position(self, position: int):
        ...
        if error != 0:
            ...
            dxl_error_message, dxl_comm_result, dxl_error = self.packetHandler.read1ByteTxRx(self.portHandler, self.DXL_ID, self.ADDR_SHUTDOWN)
...
if __name__ == "__main__":
    from datetime import datetime # TEST TIME
    import time
    gripper = Gripper()
    ...
    try:
        ...
        # Close gripper
        max_pos = 740
        gripper.set_position(200)
        gripper.wait_until_reached(200)

        # Open gripper
        gripper.set_position(0)
        gripper.wait_until_reached(0)

        # for angle in range(0,500,10):
            
        #     gripper.set_position(angle)
