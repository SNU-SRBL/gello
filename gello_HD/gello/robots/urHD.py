...
class URRobot(Robot):
    ...
    def command_joint_state(self, joint_state: np.ndarray) -> None:
        ...
        if self._use_gripper:
            ...
            gripper_pos = int(joint_state[-1] * 60) # ROBOTIS RH-P12-RN # CHANGE to corresponding gripper
            self.gripper.move(gripper_pos) # ROBOTIS RH-P12-RN # CHANGE to corresponding gripper
